  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {/* Placeholder per l'Admin che creerà la sfida */}
        <button className="text-sm bg-gray-900 border border-gray-800 hover:border-purple-500 hover:text-purple-400 text-gray-300 px-4 py-2 rounded-lg transition-colors">
          + Nuova Sfida
        </button>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {challenges.length === 0 ? (
          <div className="md:col-span-2 bg-gray-900 border border-gray-800 p-8 rounded-2xl text-center text-gray-400">
          ...
          challenges.map(challenge => {
            ...
            return (
              <div key={challenge.id} className="bg-gray-900 border border-gray-800 hover:border-purple-500/50 p-5 rounded-2xl transition-all flex flex-col h-full group shadow-lg shadow-purple-900/5">
